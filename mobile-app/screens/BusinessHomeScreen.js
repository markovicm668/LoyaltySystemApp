...
import AsyncStorage from '@react-native-async-storage/async-storage';
import Constants from 'expo-constants';
import QRCode from 'react-native-qrcode-svg'; // Assuming this is react-native-qrcode-svg
// import { configureReanimatedLogger } from 'react-native-reanimated'; // This was unused
...
// Add errorSubText to styles if you use it
const styles = StyleSheet.create({
  ...
  refreshButton: {
    backgroundColor: '#7E57C2', // Slightly different color for refresh
    paddingVertical: 14,
